...
import com.mike.aframe.database.KJDB.DbUpdateListener;
...
final public class DaoConfig {
    ...
    private String mDbName = MKConfig.DBNAME; // 数据库名字
    private int dbVersion = 1; // 数据库版本
    private boolean debug = MKConfig.isDebug; // 是否是调试模式（调试模式 增删改查的时候显示SQL语句）
