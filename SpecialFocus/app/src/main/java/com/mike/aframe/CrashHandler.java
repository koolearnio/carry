...
import com.mike.aframe.http.KJFileParams;
import com.mike.aframe.http.KJHttp;
...
//            KJActivityManager.create().finishAllActivity();
    ...
    private void saveToSDCard(Throwable ex) throws Exception {
        File file = FileUtils.getSaveFile("SpokenLog",
        ...
        pw.close();
        // 上传到服务器	add by leixun 2014.12.11
//        uploadToServer(file);
     ...
     * @since 1.0
     */
//    private void uploadToServer(File file) throws Exception{
//    	String uploadUrl = "http://192.168.10.102:8080/yybTest/update_error";
//	    PostMethod filePost = new PostMethod(uploadUrl);
//	      Part[] parts =
//	      { new FilePart(file.getName() + System.currentTimeMillis(),
//	          file)};
//	 
