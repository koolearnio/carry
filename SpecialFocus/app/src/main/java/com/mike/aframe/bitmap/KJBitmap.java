...
import com.mike.aframe.bitmap.utils.BitmapMemoryCache;
import com.mike.aframe.bitmap.utils.ImageUtils;
...
public class KJBitmap {
    ...
    public synchronized static KJBitmap create(
    	...
    	MKLog.d("", "GC_FOR_ cacheSize->"+bitmapConfig.memoryCacheSize);
        config = bitmapConfig;
        if (instance == null) {
