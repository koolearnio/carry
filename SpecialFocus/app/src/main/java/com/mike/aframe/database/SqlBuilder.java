 ...
 */
package com.mike.aframe.database;
...
import com.mike.aframe.database.utils.Id;
import com.mike.aframe.database.utils.KeyValue;
import com.mike.aframe.database.utils.ManyToOne;
import com.mike.aframe.database.utils.Property;
import com.mike.aframe.database.utils.TableInfo;
...
public class SqlBuilder {
    ...
    public static SqlInfo buildDeleteSql(Object entity) {
        ...
        if (idvalue == null) {
            throw new MKException("getDeleteSQL:" + entity.getClass()
                    + " id value is null");
        }
        StringBuffer strSQL = new StringBuffer(
    ...
    public static SqlInfo buildDeleteSql(Class<?> clazz, Object idValue) {
        ...
        if (null == idValue) {
            throw new MKException("getDeleteSQL:idValue is null");
        }
    ...
    public static SqlInfo getUpdateSqlAsSqlInfo(Object entity) {
        ...
        if (null == idvalue) {// 主键值不能为null，否则不能更新
            throw new MKException("this entity[" + entity.getClass()
                    + "]'s id value is null");
        }
