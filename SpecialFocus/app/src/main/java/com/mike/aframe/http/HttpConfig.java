...
import com.mike.aframe.http.cache.I_HttpCache;
...
public class HttpConfig {
    public static final String FileParamsName = MKConfig.HttpParamsKey;
    public static final String FileParamsKey = MKConfig.HttpParamsKey;
