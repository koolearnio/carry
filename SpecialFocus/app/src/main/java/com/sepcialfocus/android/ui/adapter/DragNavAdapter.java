 ...
 * @version  	 
 */
public class DragNavAdapter extends BaseAdapter{
	private Context mContext;
	private ArrayList<NavBean> mMenuList;
	
	public DragNavAdapter(Context context,ArrayList<NavBean> list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			convertView = LayoutInflater.from(mContext).inflate(R.layout.item_drag,null);
			holder= new ViewHolder();
			holder.menuTv = (TextView)convertView.findViewById(R.id.drag_tv);
